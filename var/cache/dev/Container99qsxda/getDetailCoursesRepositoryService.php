 ...
 */
class getDetailCoursesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DetailCoursesRepository' shared autowired service.
     *
     * @return \App\Repository\DetailCoursesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DetailCoursesRepository.php';

        return $container->privates['App\\Repository\\DetailCoursesRepository'] = new \App\Repository\DetailCoursesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
