 ...
 */
class getCoursesListRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CoursesListRepository' shared autowired service.
     *
     * @return \App\Repository\CoursesListRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CoursesListRepository.php';

        return $container->privates['App\\Repository\\CoursesListRepository'] = new \App\Repository\CoursesListRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
