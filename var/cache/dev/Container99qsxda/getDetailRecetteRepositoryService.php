 ...
 */
class getDetailRecetteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DetailRecetteRepository' shared autowired service.
     *
     * @return \App\Repository\DetailRecetteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DetailRecetteRepository.php';

        return $container->privates['App\\Repository\\DetailRecetteRepository'] = new \App\Repository\DetailRecetteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
