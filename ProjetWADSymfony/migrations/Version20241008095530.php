 ...
 */
final class Version20241008095530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recette (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, date_publication DATE DEFAULT NULL, temps_de_preparation TIME DEFAULT NULL, temps_de_cuison TIME DEFAULT NULL, difficulte INT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, saison VARCHAR(255) NOT NULL, type_de_plat VARCHAR(255) NOT NULL, origine VARCHAR(255) NOT NULL, nombre_portions INT DEFAULT NULL, INDEX IDX_49BB6390FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
